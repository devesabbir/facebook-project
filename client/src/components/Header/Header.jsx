...
import { LogOutAction } from '../../redux/userAuth/actions'
import favIcon from '../../_assets/icons/favicon.ico'
import userAvater from '../../_assets/images/user.png' 
...
const Header = () => {
    ...
    //  Handle Logout 
     const handleLogOut = (e) => {
        e.preventDefault()
        dispatch(LogOutAction(Cookies,navigate))
     }
  ...
  <div className="fb-home-header">
        ...
        <div className="search-box">
            <svg fill="currentColor" viewBox="0 0 16 16" width="1em" height="1em" className="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6 xlup9mm x1kky2od">
        ...
        <ul>
            <li className="active">
            <a href="#"><svg viewBox="0 0 28 28" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x5e5rjt" fill="currentColor" height={28} width={28}>
            ...
            <li>
            <a href="#"><svg viewBox="0 0 28 28" className="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6" fill="currentColor" height={28} width={28}>
            ...
            <li>
            <a href="#"><svg viewBox="0 0 28 28" className="x1lliihq x1k90msu x2h7rmj x1qfuztq xcza8v6" fill="currentColor" height={28} width={28}>
                <path d="M23.5 9.5H10.25a.75.75 0 00-.75.75v7c0 .414.336.75.75.75H17v5.5H4.5v-19h19v5zm0 14h-5v-6.25a.75.75 0 00-.75-.75H11V11h12.5v12.5zm1.5.25V4.25C25 3.561 24.439 3 23.75 3H4.25C3.561 3 3 3.561 3 4.25v19.5c0 .689.561 1.25 1.25 1.25h19.5c.689 0 1.25-.561 1.25-1.25z" /></svg></a>
            </li>
        </ul>
        </div>
        <div className="fb-home-user">
        <div className="fb-user-item">
            <a href="#"><svg fill="currentColor" viewBox="0 0 44 44" width="1em" height="1em" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0 x1qx5ct2 xw4jnvo">
        ...
        <div className="fb-user-item">
            <a href="#"><svg viewBox="0 0 28 28" alt="" className="x1lliihq x1k90msu x2h7rmj x1qfuztq x198g3q0" fill="currentColor" height={20} width={20}>
        ...
        <div className="fb-user-item">
           <img onClick={() => setShow(!show)} src={userAvater} alt="" />
           {
            show && <div onMouseLeave={() => setShow(!show)} className="user-menu-dropdown">
